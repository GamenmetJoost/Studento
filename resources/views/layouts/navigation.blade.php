<nav x-data="{ open: false }" class="bg-primary_blue dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <x-nav-item-responsive route="categories.index" text="Alle onderwerpen" />
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800 dark:text-gray-200">{{ Auth::user()?->name ?? 'Gast' }}</div>
