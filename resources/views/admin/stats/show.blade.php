    ...
    <div class="container mx-auto py-8">
        ...
        <form method="GET" class="bg-white p-4 rounded shadow mb-6 grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div class="flex items-end justify-end">
                <a href="{{ route('admin.stats.index') }}" class="text-gray-700 hover:underline">Terug naar overzicht</a>
            </div>
        </form>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-white p-6 rounded-lg shadow">
                <h3 class="text-lg font-semibold mb-2">Pogingen</h3>
            ...
            <div class="bg-white p-6 rounded-lg shadow">
                <h3 class="text-lg font-semibold mb-2">Goede / Totaal</h3>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Duur</th>
                    ...
                    @forelse($attempts as $attempt)
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2 text-right">
                                <a href="{{ route('quiz_attempt.result', ['attempt' => $attempt->id]) }}" class="text-blue-600 hover:underline">Details</a>
                            </td>
                        </tr>
                    @empty
                        <tr><td colspan="5" class="px-4 py-8 text-center text-gray-500">Geen resultaten</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
